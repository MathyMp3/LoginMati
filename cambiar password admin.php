...
echo "Contrasena actualizada exitosamente para el usuario: $usuario .";
} else {
...
<html lang="es">
<head>
<meta charset="UTF-8"><title>Cambiar Contrase~na de Usuarios</title>
</head>
<body>
...
,→ required><br><br>
<input type="submit" value="Actualizar Contrasena">
</form>
